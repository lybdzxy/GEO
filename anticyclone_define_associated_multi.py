...
def process_single_time(target_time, file_path_template='F:/ERA5/hourly/sfc/fin/ERA5_{hour}_sfc_{year}{month}_instant.nc'):
    ...
    try:
        ...
        potential_high_centers = calculate_potential_high_centers(leaf_contours, lon, lat, pressure_above_1010)
...
if __name__ == "__main__":
    ...
    # 输出文件路径
    output_file = 'potential_high_pressure_centers_slp.csv'
