...
for t in time_list:
    for year in range(1940, 2025):
        for month in range(1, 13):
            ...
            # Input file paths
            file1 = f'F:/ERA5/hourly/lvl/50s/ERA5_part_{time_format}z_lvl_{year}{month_format}.nc'
            file2 = f'F:/ERA5/hourly/lvl/50s/ERA5_part2_{time_format}z_lvl_{year}{month_format}.nc'
