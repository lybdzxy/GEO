...
trajectories_with_season = pd.read_csv('trajectories_with_season&region.csv')
...
# 保存筛选后的数据到新的 CSV 文件
filtered_trajectories.to_csv('trajectories_fin.csv', index=False)

print("数据清洗完成，已保存为 filtered_trajectories.csv")
