...
def process_single_time(target_time):
    ...
    try:
        ...
        def process_hemisphere(stream_data, lat_data, lon_data, hemisphere, extent):
            ...
            if hemisphere == 'Northern':
                ...
                if stream_max > 1000:
                    ...
                    with open(f'low_stream_max_log_850hpa_0360_{hemisphere}.txt', 'a', encoding='utf-8') as log_file:
                ...
                if stream_min < -1000:
                    ...
                    with open(f'high_stream_min_log_850hpa_0360_{hemisphere}.txt', 'a', encoding='utf-8') as log_file:
        ...
        # 处理南北半球
        north_centers = process_hemisphere(stream_north, lat_north, lon_filtered, 'Northern', [-180, 180, 0, 90])
        south_centers = process_hemisphere(stream_south, lat_south, lon_filtered, 'Southern', [-180, 180, -90, 0])
...
if __name__ == "__main__":
    ...
    # 输出文件路径
    output_file = 'potential_high_pressure_centers_stream_850hpa_0360_hemispheres.csv'
    ...
    with open(output_file, 'w', newline='', encoding='utf-8') as f:
        ...
        # 日志文件路径（统一保存）
        error_log_path = "error_log_stream_hemispheres_0360_85.txt"
        empty_log_path = "empty_results_log_stream_hemispheres_0360_85.txt"
